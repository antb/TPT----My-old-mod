...
void update_particles_i(pixel *vid, int start, int inc)
{
	...
	for (i=start; i<(NPART-starti); i+=inc)
		if (parts[i].type)
		{
			...
			if (parts[i].life && t!=PT_ACID  && t!=PT_COAL && t!=PT_WOOD && t!=PT_STKM && t!=PT_STKM2 && t!=PT_FUSE && t!=PT_FSEP && t!=PT_BCOL && t!=PT_GOL && t!=PT_SPNG && t!=PT_QRTZ && t!=PT_DEUT && t!=PT_PRTO && t!=PT_PRTI &&t!=PT_SDUT && t!=PT_GDUT && t!=PT_RADI && t!=PT_DBTY && t!=PT_NP2 && t!=PT_VIRU && t!=PT_CPT1 && t!=PT_CPT2) //AntB Edit -- Ignore Life
			{
				if (!(parts[i].life==10&&(t==PT_SWCH||t==PT_LCRY||t==PT_PCLN||t==PT_HSWC||t==PT_PUMP||t==PT_RNEO||t==PT_GNEO||t==PT_BNEO||t==PT_CNEO||t==PT_MNEO||t==PT_YNEO||t==PT_SBTY))) //AntB Edit -- Ignore life if 10
					parts[i].life--;
				if (parts[i].life<=0 && !(ptypes[t].properties&PROP_CONDUCTS) && t!=PT_ARAY && t!=PT_FIRW && t!=PT_SWCH && t!=PT_PCLN && t!=PT_HSWC && t!=PT_PUMP && t!=PT_SPRK && t!=PT_LAVA && t!=PT_LCRY && t!=PT_QRTZ && t!=PT_GLOW && t!= PT_FOG && t!=PT_PIPE && t!=PT_FRZW &&(t!=PT_ICEI&&parts[i].ctype!=PT_FRZW)&&t!=PT_INST && t!=PT_SHLD1&& t!=PT_SHLD2&& t!=PT_SHLD3&& t!=PT_SHLD4 && t!=PT_SING &&
                     t!=PT_RNEO && t!=PT_GNEO && t!=PT_BNEO && t!=PT_CNEO && t!=PT_MNEO && t!=PT_YNEO && t!=PT_SBTY && t!=PT_DBTY) //AntB Edit
				{
					kill_part(i);
					continue;
				}
